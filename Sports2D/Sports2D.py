...
CONFIG_HELP =   {'config': ["C", "path to a toml configuration file"],
                ...
                'synthpose_detector': ["", "'yolox' (rtmlib, faster) or 'rtdetr' (HuggingFace Transformers, original SynthPose_PM detector). yolox if not specified"],
                ...
                'detect_ball': ["", "true or false. enable sports ball detection and draw center + trajectory when detector metadata is available. false if not specified"],
