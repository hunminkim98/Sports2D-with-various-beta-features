...
DEFAULT_CONFIG =   {'base': {'video_input': ['demo.mp4'],
                                ...
                                'save_angles': True,
                                'result_dir': '',
                                'show_heel_trajectory': False,
                                'heel_trajectory_length': 50
                                },
                    ...
                    'angles':   {'display_angle_values_on': ['body', 'list'],
                                ...
                                'segment_angles': [ 'Right foot',
                                                    ...
                                                    'Right forearm',
                                                    'Left forearm',
                                                    'Right inversion/eversion',
                                                    'Left inversion/eversion'],
...
CONFIG_HELP =   {'config': ["C", "path to a toml configuration file"],
                ...
                'show_heel_trajectory': ["", "show heel trajectory for running analysis. false if not specified"],
                'heel_trajectory_length': ["", "heel trajectory length in frames or 'all' for entire video. 50 if not specified"],
