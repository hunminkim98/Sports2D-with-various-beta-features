...
CONFIG_HELP =   {'config': ["C", "path to a toml configuration file"],
                ...
                'motion_type': ["", "'generic' or 'throw'. If 'throw', shoulder angles are forced to continuous 360-cycle representation across realtime display and saved outputs. generic if not specified"],
